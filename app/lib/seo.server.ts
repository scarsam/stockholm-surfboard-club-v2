...
function root({
  ...
  return {
    ...
    jsonLd: {
      ...
      sameAs: [
        'https://twitter.com/stockholm-surboard-club',
        'https://facebook.com/stockholm-surboard-club',
        'https://instagram.com/stockholm-surboard-club',
        'https://youtube.com/stockholm-surboard-club',
        'https://tiktok.com/@stockholm-surboard-club',
      ],
      url,
      potentialAction: {
        '@type': 'SearchAction',

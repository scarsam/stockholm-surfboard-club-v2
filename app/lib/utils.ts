...
export const INPUT_STYLE_CLASSES =
  'appearance-none rounded dark:bg-transparent border border-black focus:border-primary/50 focus:ring-0 w-full py-2 px-3 text-black leading-tight focus:shadow-outline';
